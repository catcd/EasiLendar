...
public class WelcomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // if last page import screen will be launched
    ...
    private void launchHomeScreen() {
        Intent i = new Intent(WelcomeActivity.this, WeekCalendarActivity.class);
    ...
    private void launchImport() {
        startActivity(new Intent(WelcomeActivity.this, ImportCalendarActivity.class));
        finish();
    }
    ...
    ViewPager.OnPageChangeListener viewPagerPageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            // changing the next button text 'NEXT' / 'IMPORT NOW'
            // changing the next button text 'SKIP' / 'GOT IT'
            if (position == layouts.length - 1) {
                // last page. make button text to GOT IT
                btnNext.setText(getString(R.string.import_now));
